...
-- List of Drugs: -- Should not be modified, the shit will break due to me being lazy sry -- ONLY EDIT IF YOU KNOW WHAT YOU ARE DOING BEST REGARDS OMIKKEL
Config.ListOfDrugs = {
	{ drug = 'coke', label = 'Coke', Enabled = true, BuyPrice = 7500, MinReward = 80, MaxReward = 110, drugcode = "coke1g", drugdesc = "", drugweight = 0.01},
	{ drug = 'meth', label = 'Meth', Enabled = true, BuyPrice = 6000, MinReward = 70, MaxReward = 90, drugcode = "meth1g", drugdesc = "",drugweight = 0.01},
	{ drug = 'weed', label = 'Weed', Enabled = true, BuyPrice = 3500, MinReward = 60, MaxReward = 65, drugcode = "weed4g", drugdesc = "", drugweight = 0.01 },
}
...
Config.CokeDrug = "coke1g"						-- CHANGE THIS TO VRP ITEM SPAWNCODE
Config.MethDrug = "meth1g"						-- CHANGE THIS TO VRP ITEM SPAWNCODE
Config.WeedDrug = "weed4g"						-- CHANGE THIS TO VRP ITEM SPAWNCODE
Config.CallPoliceChance = 4						-- 2 means 50%, 3 means 33%, 4 means 25% and etc
...
Config.DrugConversion = {
	{ 
		UsableItem 				= "cokebrick",					-- CHANGE THIS TO VRP ITEM SPAWNCODE -- ITEM USED TO DO DRUG CONVERSION
		RewardItem 				= "coke10g",					-- CHANGE THIS TO VRP ITEM SPAWNCODE -- ITEM RECEIVED AFTER DRUG CONVERSION
		...
		RequiredItem 			= "drugbags",					-- CHANGE THIS TO VRP ITEM SPAWNCODE -- ITEM IS REQUIRED TO START DRUG CONVERSION
	...
	{ 
		UsableItem 				= "methbrick",					-- CHANGE THIS TO VRP ITEM SPAWNCODE -- ITEM USED TO DO DRUG CONVERSION
		RewardItem 				= "meth10g",					-- CHANGE THIS TO VRP ITEM SPAWNCODE -- ITEM RECEIVED AFTER DRUG CONVERSION
		RewardAmount 			= {a = 6, b = 10},				-- Amount of RewardItem player receives. "a" is without scale and "b" is with scale
		MaxRewardItemInv		= {e = 44, f = 40},				-- Amount of RewardItem player can hold in inventory. "e" is without scale and "f" is with scale
		RequiredItem 			= "drugbags",					-- CHANGE THIS TO VRP ITEM SPAWNCODE -- ITEM IS REQUIRED TO START DRUG CONVERSION
		RequiredItemAmount 		= {c = 6, d = 10},				-- Amount of RequiredItem for conversion. "c" is without scale and "d" is with scale
	...
	{ 
		UsableItem 				= "weedbrick",					-- CHANGE THIS TO VRP ITEM SPAWNCODE -- ITEM USED TO DO DRUG CONVERSION
		RewardItem 				= "weed20g",					-- CHANGE THIS TO VRP ITEM SPAWNCODE -- ITEM RECEIVED AFTER DRUG CONVERSION
	...
	{ 
		UsableItem 				= "coke10g",					-- CHANGE THIS TO VRP ITEM SPAWNCODE -- ITEM USED TO DO DRUG CONVERSION
		RewardItem 				= "coke1g",						-- CHANGE THIS TO VRP ITEM SPAWNCODE -- ITEM RECEIVED AFTER DRUG CONVERSION
		RewardAmount 			= {a = 6, b = 10},				-- Amount of RewardItem player receives. "a" is without scale and "b" is with scale
		MaxRewardItemInv		= {e = 44, f = 40},				-- Amount of RewardItem player can hold in inventory. "e" is without scale and "f" is with scale
		RequiredItem 			= "drugbags",					-- CHANGE THIS TO VRP ITEM SPAWNCODE -- ITEM IS REQUIRED TO START DRUG CONVERSION
		RequiredItemAmount 		= {c = 6, d = 10},				-- Amount of RequiredItem for conversion. "c" is without scale and "d" is with scale
	...
	{ 
		UsableItem 				= "meth10g",					-- CHANGE THIS TO VRP ITEM SPAWNCODE -- ITEM USED TO DO DRUG CONVERSION
		RewardItem 				= "meth1g",						-- CHANGE THIS TO VRP ITEM SPAWNCODE -- ITEM RECEIVED AFTER DRUG CONVERSION
		RewardAmount 			= {a = 6, b = 10},				-- Amount of RewardItem player receives. "a" is without scale and "b" is with scale
		MaxRewardItemInv		= {e = 44, f = 40},				-- Amount of RewardItem player can hold in inventory. "e" is without scale and "f" is with scale
		RequiredItem 			= "drugbags",					-- CHANGE THIS TO VRP ITEM SPAWNCODE -- ITEM IS REQUIRED TO START DRUG CONVERSION
		RequiredItemAmount 		= {c = 6, d = 10},				-- Amount of RequiredItem for conversion. "c" is without scale and "d" is with scale
	...
	{ 
		UsableItem 				= "weed20g",					-- CHANGE THIS TO VRP ITEM SPAWNCODE -- ITEM USED TO DO DRUG CONVERSION
		RewardItem 				= "weed4g",						-- CHANGE THIS TO VRP ITEM SPAWNCODE -- ITEM RECEIVED AFTER DRUG CONVERSION
	...
	{ 
		UsableItem 				= "weed4g",						-- CHANGE THIS TO VRP ITEM SPAWNCODE -- ITEM USED TO DO DRUG CONVERSION
		RewardItem 				= "joint2g",					-- CHANGE THIS TO VRP ITEM SPAWNCODE -- ITEM RECEIVED AFTER DRUG CONVERSION
		RewardAmount 			= 2,							-- Amount of RewardItem player receives
		MaxRewardItemInv		= {e = 44, f = 40},				-- Amount of RewardItem player can hold in inventory. "e" is without scale and "f" is with scale
		RequiredItem 			= "rolpaper",					-- CHANGE THIS TO VRP ITEM SPAWNCODE -- ITEM IS REQUIRED TO START DRUG CONVERSION
