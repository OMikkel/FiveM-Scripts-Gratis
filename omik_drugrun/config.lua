...
config.jobcooldown = 30 -- Minutter / Hvor lang cooldown skal der være i mellem hver mision man starter
config.npcswaptime = 30 -- Minutter / Hvor lang tid skal der gå mellem startnpc'erne skifter lokation

config.receiveBlackmoney = false -- Skal man modtage sorte penge i stedet for kontanter
config.receiveBankmoney = true -- Skal man modtage penge i banken i stedet for kontanter
config.blackmoneyname = "dirty_money" -- Navnet på sorte penge, find det i vrp>cfg>items.lua eller lignende sted

config.npcs = true -- Skal npcs spawn
config.markers = true -- Skal der laves markers
config.blips = true -- Skal der være blips

config.bliptext = "Friendly Frans"

config.markertype = 27 -- https://docs.fivem.net/docs/game-references/markers/
config.markercolor = {79, 97, 247} -- R,G,B / Hvilken farve skal markeren have?
config.markerscale = {1.5,1.5,1.5} -- ScaleX, ScaleY, ScaleZ / Hvor stor skal markeren være?

config.drugs = {
    coke = {
        sellprice = {5700, 6250}, -- Hvor meget skal man have pr papkasse man aflevere? / min, max
        boxes = 4 -- Hvor mange papkasser skal man aflevere på den her opgave - Max 5 kasser ellers skal i ændre lidt i koden
    },
    meth = {
        sellprice = {5850, 6000}, -- Hvor meget skal man have pr papkasse man aflevere? / min, max
        boxes = 5 -- Hvor mange papkasser skal man aflevere på den her opgave - Max 5 kasser ellers skal i ændre lidt i koden
    },
    weed = {
        sellprice = {5500, 6666}, -- Hvor meget skal man have pr papkasse man aflevere? / min, max
        boxes = 3 -- Hvor mange papkasser skal man aflevere på den her opgave - Max 5 kasser ellers skal i ændre lidt i koden
    }
}

config.locations = {
    start = { -- Peds som du kan få et job hos
        {
            coords = {1268.8291015625,-1710.1306152344,54.771446228027}, -- coords for ped, marker, 3dtekst
            heading = 288.0, -- ped heading
            radius = 1.5, -- radius for hvornår du kan se 3d teksten
            marker = true, -- skal der være marker under ped
            ped = "G_M_Y_MexGang_01", -- ped som bliver spawnet
            animdict = "rcmme_amanda1", -- ped animation
            animname = "stand_loop_cop", -- ped animation
            jobs = "random" -- definere hvilke jobs den her ped kan give air/ground/random
        },
        {
            coords = {138.93324279785,-1921.716796875,21.380819320679},
            heading = 304.0,
            radius = 1.5,
            marker = true,
            ped = "G_M_Y_Lost_02",
        ...
        {
            coords = {918.41235351563,-648.35369873047,58.242378234863},
            heading = 144.0,
            radius = 1.5,
            marker = true,
            ped = "G_M_Y_SalvaBoss_01",
            animdict = "world_human_leaning@male@wall@back@legs_crossed@base",
            animname = "base",
            jobs = "random"
        }
    },
    air = { -- config for alle jobs som har noget med fly at gøre
        {
            coords = {1734.1007080078,3315.4104003906,41.223499298096}, -- coords hvor køretøjet spawner
            heading = 170.0, -- køretøjets heading
            lockpickcoords = {1735.4245605469,3314.771484375,42.385883331299}, -- coords til hvor ped står når du lockpicker køretøjet
            lockpickheading = 107.0, -- den retning din ped vender når du lockpicker
            vehicle = "cuban800", -- køretøjets spawncode
            drugs = "random", -- definere hvilke drugs du kan arbejde med i den her mission kan være meth/coke/weed/random
            boxes = { -- coords til papkasser som man skal samle op
                {1739.5550537109,3318.6823730469,41.223518371582},
                {1739.0319824219,3320.4123535156,41.223533630371},
                {1737.5305175781,3320.5532226563,41.223518371582},
                {1731.1038818359,3322.9833984375,41.223510742188},
                {1733.4327392578,3323.9626464844,41.223510742188}
            }
        },
        {
            coords = {2133.3256835938,4783.13671875,40.970283508301}, -- coords hvor køretøjet spawner
            heading = 24.0, -- køretøjets heading
            lockpickcoords = {2132.4680175781,4781.7626953125,40.970275878906}, -- coords til hvor ped står når du lockpicker køretøjet
            lockpickheading = 311.0, -- den retning din ped vender når du lockpicker
            vehicle = "duster", -- køretøjets spawncode
            drugs = "random", -- definere hvilke drugs du kan arbejde med i den her mission kan være meth/coke/weed/random
            boxes = { -- coords til papkasser som man skal samle op
                {2129.5612792969,4777.9418945313,40.970275878906},
                {2131.2014160156,4775.6909179688,40.970275878906},
                {2142.3056640625,4772.96875,41.02326965332},
                {2141.2233886719,4771.6928710938,41.039840698242},
                {2131.6149902344,4771.5922851563,40.970371246338}
            }
        },
        {
            coords = {-1599.3863525391,5260.3515625,1.3202984333038}, -- coords hvor køretøjet spawner
            heading = 324.0, -- køretøjets heading
            lockpickcoords = {-1600.6702880859,5260.9409179688,1.3879529237747}, -- coords til hvor ped står når du lockpicker køretøjet
            lockpickheading = 236.0, -- den retning din ped vender når du lockpicker
            vehicle = "dodo", -- køretøjets spawncode
            drugs = "random", -- definere hvilke drugs du kan arbejde med i den her mission kan være meth/coke/weed/random
            boxes = { -- coords til papkasser som man skal samle op
                {-1612.5632324219,5255.2700195313,3.9741010665894},
                {-1613.0633544922,5256.7338867188,3.9741010665894},
                {-1611.9259033203,5253.9291992188,3.9741010665894},
                {-1612.8259277344,5257.4345703125,3.9741010665894},
                {-1612.9962158203,5259.0444335938,3.9741010665894}
            }
        },
        {
            coords = {-791.64019775391,-1500.5385742188,1.3200011253357}, -- coords hvor køretøjet spawner
            heading = 111.0, -- køretøjets heading
            lockpickcoords = {-791.00134277344,-1501.6551513672,1.3880177736282}, -- coords til hvor ped står når du lockpicker køretøjet
            lockpickheading = 20.5, -- den retning din ped vender når du lockpicker
            vehicle = "dodo", -- køretøjets spawncode
            drugs = "random", -- definere hvilke drugs du kan arbejde med i den her mission kan være meth/coke/weed/random
            boxes = { -- coords til papkasser som man skal samle op
                {-781.18304443359,-1506.0307617188,1.5952131748199},
                {-785.48083496094,-1506.9375,1.5952131748199},
                {-788.50689697266,-1491.1398925781,1.5952082872391},
                {-792.45074462891,-1492.9586181641,1.5952172279358},
                {-796.27545166016,-1493.9991455078,1.5952172279358}
            }
        },
        {
            coords = {-1667.3377685547,-3132.6401367188,13.992141723633}, -- coords hvor køretøjet spawner
            heading = 330.0, -- køretøjets heading
            lockpickcoords = {-1668.5949707031,-3131.5942382813,15.295394897461}, -- coords til hvor ped står når du lockpicker køretøjet
            lockpickheading = 277.0, -- den retning din ped vender når du lockpicker
            vehicle = "velum2", -- køretøjets spawncode
            drugs = "random", -- definere hvilke drugs du kan arbejde med i den her mission kan være meth/coke/weed/random
            boxes = { -- coords til papkasser som man skal samle op
                {-1680.1389160156,-3132.2614746094,13.991171836853},
                {-1681.5112304688,-3134.4868164063,13.991161346436},
                {-1678.6300048828,-3129.0788574219,13.991143226624},
                {-1682.2598876953,-3139.5275878906,13.99090385437},
                {-1676.4560546875,-3136.1577148438,13.991433143616}
            }
        },
        {
            coords = {-1635.9847412109,-3151.1328125,13.992218971252}, -- coords hvor køretøjet spawner
            heading = 330.0, -- køretøjets heading
            lockpickcoords = {-1637.3297119141,-3150.1447753906,13.99222946167}, -- coords til hvor ped står når du lockpicker køretøjet
            lockpickheading = 239.0, -- den retning din ped vender når du lockpicker
            vehicle = "mammatus", -- køretøjets spawncode
            drugs = "random", -- definere hvilke drugs du kan arbejde med i den her mission kan være meth/coke/weed/random
            boxes = { -- coords til papkasser som man skal samle op
                {-1646.9938964844,-3158.5969238281,13.992217063904},
                {-1648.8647460938,-3159.6176757813,13.992217063904},
                {-1650.8973388672,-3156.8874511719,13.992221832275},
                {-1654.6807861328,-3158.3498535156,13.992221832275},
                {-1647.3625488281,-3152.1943359375,13.992234230042}
            }
        }
    },
    sea = { -- config for alle jobs som har noget med vand at gøre

        -- UNDER UDVIKLING LIGE PT, SKAL LIGE TAGE MIG SAMMEN TIL AT LAVE COORDS TIL DET... DER KOMMER EN V2 MED DET, DET LOVER JEG.

    },
    ground = { -- config for alle jobs som sker på land
        {
            coords = {-104.86716461182,-1599.6893310547,31.69144821167}, -- coords hvor køretøjet spawner
            heading = 336.0, -- køretøjets heading
            lockpickcoords = {-106.46536254883,-1598.3552246094,31.6370677948}, -- coords til hvor ped står når du lockpicker køretøjet
            lockpickheading = 240.0, -- den retning din ped vender når du lockpicker
            vehicle = "burrito", -- køretøjets spawncode
            drugs = "random", -- definere hvilke drugs du kan arbejde med i den her mission kan være meth/coke/weed/random
            boxes = { -- coords til papkasser som man skal samle op
                {-101.84800720215,-1606.9415283203,31.769058227539},
                {-101.18573760986,-1607.7855224609,31.782600402832},
                {-100.47802734375,-1608.158203125,31.822263717651},
                {-96.713088989258,-1606.5040283203,32.283569335938},
                {-98.297492980957,-1605.2907714844,31.81600189209}
            }
        },
        {
            coords = {-1792.8487548828,458.15518188477,128.3081817627},
            heading = 82.0,
            lockpickcoords = {-1792.9638671875,456.23126220703,128.3081817627},
            lockpickheading = 350.0,
            vehicle = "baller3",
            drugs = "random",
            boxes = {
                {-1786.5170898438,457.39517211914,128.30815124512},
                {-1787.0437011719,456.328125,128.30815124512},
                {-1789.3582763672,461.3069152832,128.30815124512},
                {-1788.6276855469,463.50192260742,128.30815124512},
                {-1791.2225341797,453.89093017578,128.30815124512}
            }
        },
        {
            coords = {-1890.3715820313,2046.5180664063,140.86535644531},
            heading = 243.0,
            lockpickcoords = {-1889.7780761719,2048.0197753906,140.87034606934},
            lockpickheading = 150.0,
            vehicle = "mesa3",
            drugs = "random",
            boxes = {
                {-1891.8912353516,2050.9370117188,140.98916625977},
                {-1893.2752685547,2052.1372070313,140.9907989502},
                {-1895.8499755859,2045.3367919922,140.83375549316},
                {-1890.1417236328,2049.7524414063,140.98735046387},
                {-1891.4506835938,2050.7319335938,140.9884185791}
            }
        },
        {
            coords = {63.584327697754,121.9016418457,79.149185180664},
            heading = 190.0,
            lockpickcoords = {65.466186523438,121.77585601807,79.129638671875},
            lockpickheading = 97.0,
            vehicle = "boxville2",
            drugs = "random",
            boxes = {
                {66.830909729004,126.34107208252,79.182281494141},
                {65.63809967041,127.97603607178,79.192451477051},
                {60.409843444824,126.57466888428,79.231468200684},
                {60.264976501465,128.37890625,79.222816467285},
                {65.850410461426,125.0657119751,79.162879943848}
            }
        },
        {
            coords = {692.9013671875,-1011.4735717773,22.739736557007},
            heading = 355.0,
            lockpickcoords = {691.13781738281,-1010.701965332,22.719467163086},
            lockpickheading = 262.0,
            vehicle = "boxville4",
            drugs = "random",
            boxes = {
                {689.09844970703,-1013.2072753906,22.655591964722},
                {689.71545410156,-1016.3336791992,22.619953155518},
                {691.31976318359,-1016.9393920898,22.633007049561},
                {694.11285400391,-1017.8731079102,22.653230667114},
                {696.27850341797,-1015.2986450195,22.726020812988}
            }
        },
        {
            coords = {1906.0731201172,564.64538574219,175.82171630859},
            heading = 246.0,
            lockpickcoords = {1907.2296142578,566.17639160156,175.82159423828},
            lockpickheading = 147.0,
            vehicle = "rumpo",
            drugs = "random",
            boxes = {
                {1908.2719726563,575.93298339844,175.82159423828},
                {1906.3519287109,575.5224609375,175.82160949707},
                {1910.478515625,573.87005615234,175.82162475586},
                {1903.9089355469,569.23889160156,175.82162475586},
                {1902.0554199219,563.41809082031,175.82272338867}
            }
        },
    }
}

config.pedcombinations = { -- Hurtigt udvalgte peds, nogle er lidt fucked. Husk at ped skal være hash det ligegyldigt med string eller ej
    {ped = "-1872961334", animdict = "world_human_leaning@male@wall@back@legs_crossed@base", animname = "base"},
    {ped = "-1109568186", animdict = "rcmme_amanda1", animname = "stand_loop_cop"},
    {ped = "1032073858", animdict = "amb@world_human_cop_idles@female@base", animname = "base"},
    {ped = "-252946718", animdict = "rcmme_amanda1", animname = "stand_loop_cop"},
    {ped = "-1643617475", animdict = "world_human_leaning@male@wall@back@legs_crossed@base", animname = "base"},
    {ped = "-815646164", animdict = "amb@world_human_cop_idles@female@base", animname = "base"},
    {ped = "588969535", animdict = "rcmme_amanda1", animname = "stand_loop_cop"},
    {ped = "-198252413", animdict = "rcmme_amanda1", animname = "stand_loop_cop"},
    {ped = "599294057", animdict = "amb@world_human_cop_idles@female@base", animname = "base"},
    {ped = "-1492432238", animdict = "world_human_leaning@male@wall@back@legs_crossed@base", animname = "base"},
    {ped = "1984382277", animdict = "rcmme_amanda1", animname = "stand_loop_cop"},
    {ped = "1984382277", animdict = "world_human_leaning@male@wall@back@legs_crossed@base", animname = "base"},
    {ped = "1975732938", animdict = "amb@world_human_cop_idles@female@base", animname = "base"},
    {ped = "-1176698112", animdict = "amb@world_human_cop_idles@female@base", animname = "base"},
    {ped = "275618457", animdict = "world_human_leaning@male@wall@back@legs_crossed@base", animname = "base"},
    {ped = "-166363761", animdict = "rcmme_amanda1", animname = "stand_loop_cop"},
    {ped = "-1463670378", animdict = "rcmme_amanda1", animname = "stand_loop_cop"},
    {ped = "-1660909656", animdict = "world_human_leaning@male@wall@back@legs_crossed@base", animname = "base"},
    {ped = "-459818001", animdict = "world_human_leaning@male@wall@back@legs_crossed@base", animname = "base"},
    {ped = "377976310", animdict = "amb@world_human_cop_idles@female@base", animname = "base"},
    {ped = "1161072059", animdict = "amb@world_human_cop_idles@female@base", animname = "base"},
    {ped = "-2077218039", animdict = "world_human_leaning@male@wall@back@legs_crossed@base", animname = "base"},
    {ped = "1641152947", animdict = "rcmme_amanda1", animname = "stand_loop_cop"},
    {ped = "1558115333", animdict = "rcmme_amanda1", animname = "stand_loop_cop"},
    {ped = "728636342", animdict = "world_human_leaning@male@wall@back@legs_crossed@base", animname = "base"},
    {ped = "-294281201", animdict = "amb@world_human_cop_idles@female@base", animname = "base"},
    {ped = "-775102410", animdict = "rcmme_amanda1", animname = "stand_loop_cop"},
    {ped = "-1567723049", animdict = "world_human_leaning@male@wall@back@legs_crossed@base", animname = "base"},
    {ped = "-396800478", animdict = "rcmme_amanda1", animname = "stand_loop_cop"},
    {ped = "-961242577", animdict = "amb@world_human_cop_idles@female@base", animname = "base"},
    {ped = "-1289578670", animdict = "rcmme_amanda1", animname = "stand_loop_cop"},
    {ped = "1794449327", animdict = "world_human_leaning@male@wall@back@legs_crossed@base", animname = "base"},
    {ped = "1794449327", animdict = "amb@world_human_cop_idles@female@base", animname = "base"},
    {ped = "1704428387", animdict = "rcmme_amanda1", animname = "stand_loop_cop"},
    {ped = "1099825042", animdict = "rcmme_amanda1", animname = "stand_loop_cop"},
    {ped = "1822107721", animdict = "amb@world_human_cop_idles@female@base", animname = "base"},
    {ped = "-264140789", animdict = "world_human_leaning@male@wall@back@legs_crossed@base", animname = "base"},
    {ped = "2097407511", animdict = "rcmme_amanda1", animname = "stand_loop_cop"},
    {ped = "587703123", animdict = "world_human_leaning@male@wall@back@legs_crossed@base", animname = "base"},
    {ped = "-573920724", animdict = "amb@world_human_cop_idles@female@base", animname = "base"},
    {ped = "-835930287", animdict = "amb@world_human_cop_idles@female@base", animname = "base"},
    {ped = "1153203121", animdict = "world_human_leaning@male@wall@back@legs_crossed@base", animname = "base"},
    {ped = "1459905209", animdict = "rcmme_amanda1", animname = "stand_loop_cop"},
    {ped = "-1105179493", animdict = "rcmme_amanda1", animname = "stand_loop_cop"},
    {ped = "-619494093", animdict = "world_human_leaning@male@wall@back@legs_crossed@base", animname = "base"},
    {ped = "-346957479", animdict = "world_human_leaning@male@wall@back@legs_crossed@base", animname = "base"},
    {ped = "1530648845", animdict = "amb@world_human_cop_idles@female@base", animname = "base"},
    {ped = "-782401935", animdict = "amb@world_human_cop_idles@female@base", animname = "base"},
    {ped = "355916122", animdict = "world_human_leaning@male@wall@back@legs_crossed@base", animname = "base"},
    {ped = "1706635382", animdict = "rcmme_amanda1", animname = "stand_loop_cop"},
    {ped = "1302784073", animdict = "rcmme_amanda1", animname = "stand_loop_cop"},
    {ped = "1401530684", animdict = "world_human_leaning@male@wall@back@legs_crossed@base", animname = "base"},
    {ped = "1330042375", animdict = "amb@world_human_cop_idles@female@base", animname = "base"},
    {ped = "-927261102", animdict = "rcmme_amanda1", animname = "stand_loop_cop"},
}

config.destinations = { -- vRP_delivery coordslist / magtede sgu ikke lige finde 400 coords, så nogle af menneskerne hænger i luften. Fix det selv hvis det stresser jer!
    { x = -11.7389554977417, y = -303.995056152344, z = 45.57472221750391},
    ...
    { x = -47.6948432922363, y = -785.2351750878906, z = 43.8152542114258},
    ...
    { x = -107.097640991211, y = -1598.892150019531, z = 31.2714824676514},
    ...
    { x = 393.531311035156, y = -1436.615004394531, z = 28.8963184356689},
    ...
    { x = 298.5281750146484, y = -1802.91943359375, z = 27.0873889923096},
    ...
    { x = -695.2847217503906, y = 40.4299240112305, z = 42.7703437805176},
    ...
    { x = -1339.50646972656, y = -1210.49499511719, z = 3.968231671500903},
    ...
    { x = -1105.31286621094, y = -1681.4150390625, z = 3.621750733947754},
    ...
    { x = -1407.99182128906, y = -735.1500415039063, z = 23.0887184143066},
    ...
    { x = 946.368469238281, y = -1697.913201500781, z = 29.6896724700928},
    ...
    { x = 639.1944515007813, y = 2775.55639648438, z = 41.4039115905762},
